...
def search_users_vk(
    age_from: int, age_to: int, gender: int, city: int, vk_api: VK
) -> list:
    params = {
        "age_from": age_from,
        "age_to": age_to,
...
def send_user_info(
    user_id: int, user_name: str, vk_link: str, top_photos: list, vk_api: VK
):
...
def get_user_info_by_link(link: str, vk_api: VK) -> dict:
    params = {"user_ids": link, "fields": "photo_max_orig"}
